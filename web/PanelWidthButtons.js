...
var ce = re.extend("focustrap", {
  ...
  methods: {
    ...
    bind: function(e, n) {
      var o = this, a = n.value || {}, i = a.onFocusIn, b = a.onFocusOut;
    ...
    autoElementFocus: function(e, n) {
      var o = n.value || {}, a = o.autoFocusSelector, i = a === void 0 ? "" : a, b = o.firstFocusableSelector, l = b === void 0 ? "" : b, c = o.autoFocus, m = c === void 0 ? !1 : c, s = r.getFirstFocusableElement(e, "[autofocus]".concat(this.getComputedSelector(i)));
      m && !s && (s = r.getFirstFocusableElement(e, this.getComputedSelector(l))), r.focus(s);
    },
    ...
    createHiddenFocusableElements: function(e, n) {
      var o = this, a = n.value || {}, i = a.tabIndex, b = i === void 0 ? 0 : i, l = a.firstFocusableSelector, c = l === void 0 ? "" : l, m = a.lastFocusableSelector, s = m === void 0 ? "" : m, d = function(D) {
...
function ye(t, e, n, o, a, i) {
  return i.inline ? C(t.$slots, "default", {
    key: 0
  }) : a.mounted ? (u(), w(Y, {
    key: 1,
    to: n.appendTo
  }, [C(t.$slots, "default")], 8, ["to"])) : v("", !0);
}
N.render = ye;
var we = {
  mask: function(e) {
  ...
  methods: {
    ...
    bindDocumentDragListener: function() {
      ...
      this.documentDragListener = function(n) {
        if (e.dragging) {
          var o = r.getOuterWidth(e.container), a = r.getOuterHeight(e.container), i = n.pageX - e.lastPageX, b = n.pageY - e.lastPageY, l = e.container.getBoundingClientRect(), c = l.left + i, m = l.top + b, s = r.getViewport(), d = getComputedStyle(e.container), h = parseFloat(d.marginLeft), g = parseFloat(d.marginTop);
          e.container.style.position = "fixed", e.keepInViewport ? (c >= e.minX && c + o < s.width && (e.lastPageX = n.pageX, e.container.style.left = c - h + "px"), m >= e.minY && m + a < s.height && (e.lastPageY = n.pageY, e.container.style.top = m - g + "px")) : (e.lastPageX = n.pageX, e.container.style.left = c - h + "px", e.lastPageY = n.pageY, e.container.style.top = m - g + "px");
        }
...
function _e(t, e, n, o, a, i) {
  ...
  return u(), w(b, {
    ...
    default: I(function() {
      return [a.containerVisible ? (u(), p("div", f({
        key: 0,
        ref: i.maskRef,
        class: t.cx("mask"),
        style: t.sx("mask", !0, {
        ...
        default: I(function() {
          return [t.visible ? $((u(), p("div", f({
            ...
            "aria-modal": t.modal
          }, t.ptmi("root")), [t.$slots.container ? C(t.$slots, "container", {
            key: 0,
            onClose: i.close,
          ...
          }, t.ptm("header")), [C(t.$slots, "header", {
            class: z(t.cx("title"))
          }, function() {
            return [t.header ? (u(), p("span", f({
              key: 0,
            ...
            return [(u(), w(O(t.closeIcon ? "span" : "TimesIcon"), f({
              class: [t.cx("closeButtonIcon"), t.closeIcon]
            }, t.ptm("closeButtonIcon")), null, 16, ["class"]))];
          })], 16, Ie)), [[l]]) : v("", !0)], 16)], 16)) : v("", !0), y("div", f({
            ref: i.contentRef,
            class: [t.cx("content"), t.contentClass],
            style: t.contentStyle
          }, S(S({}, t.contentProps), t.ptm("content"))), [C(t.$slots, "default")], 16), t.footer || t.$slots.footer ? (u(), p("div", f({
            key: 1,
        ...
        _: 3
      }, 16, ["onBeforeEnter", "onEnter", "onAfterEnter", "onBeforeLeave", "onLeave", "onAfterLeave"])], 16)) : v("", !0)];
    }),
    _: 3
  }, 8, ["appendTo"]);
}
...
Oe.render = Ve;
function Ae({ storageKey: t, defaultWidth: e, presets: n, fullVw: o = 94 }) {
  function a() {
    try {
  ...
  const l = ne(a()), c = A(() => b(l.value));
  function m(s) {
    l.value = s, i(s);
  }
  return { cssWidth: c, setWidth: m, presets: n };
}
const je = { class: "width-row" }, Me = {
  ...
  setup(t) {
    return (e, n) => (u(), p("div", je, [
      (u(!0), p(R, null, ie(t.presets, (o) => (u(), w(P(H), {
        key: o,
        label: String(o),
        text: "",
        size: "small",
