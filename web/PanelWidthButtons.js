import { a4 as U, H as r, a1 as X, b as u, i as b, D as m, d as w, $ as k, C as v, c as C, a5 as Y, h as y, y as G, z as q, J as $, a as I, e as T, T as J, K as x, F as R, k as z, t as O, E as P, g as Q, R as ee, G as te, U as F, Z as B, l as A, r as ne, _ as oe, j as ie, u as _, s as H } from "./styles_link.js";
var ae = {}, re = U.extend({
  style: ae
});
function E(t) {
...
var ce = re.extend("focustrap", {
  ...
  methods: {
    ...
    autoElementFocus: function(e, n) {
      var o = n.value || {}, a = o.autoFocusSelector, i = a === void 0 ? "" : a, p = o.firstFocusableSelector, l = p === void 0 ? "" : p, c = o.autoFocus, f = c === void 0 ? !1 : c, s = r.getFirstFocusableElement(e, "[autofocus]".concat(this.getComputedSelector(i)));
      f && !s && (s = r.getFirstFocusableElement(e, this.getComputedSelector(l))), r.focus(s);
    },
    ...
    createHiddenFocusableElements: function(e, n) {
      var o = this, a = n.value || {}, i = a.tabIndex, p = i === void 0 ? 0 : i, l = a.firstFocusableSelector, c = l === void 0 ? "" : l, f = a.lastFocusableSelector, s = f === void 0 ? "" : f, d = function(D) {
      ...
      }, h = d(this.onFirstHiddenElementFocus), g = d(this.onLastHiddenElementFocus);
      h.$_pfocustrap_lasthiddenfocusableelement = g, h.$_pfocustrap_focusableselector = c, h.setAttribute("data-pc-section", "firstfocusableelement"), g.$_pfocustrap_firsthiddenfocusableelement = h, g.$_pfocustrap_focusableselector = s, g.setAttribute("data-pc-section", "lastfocusableelement"), e.prepend(h), e.append(g);
    }
  }
}), K = {
  name: "TimesIcon",
...
var we = {
  ...
  methods: {
    ...
    bindDocumentDragListener: function() {
      ...
      this.documentDragListener = function(n) {
        if (e.dragging) {
          var o = r.getOuterWidth(e.container), a = r.getOuterHeight(e.container), i = n.pageX - e.lastPageX, p = n.pageY - e.lastPageY, l = e.container.getBoundingClientRect(), c = l.left + i, f = l.top + p, s = r.getViewport(), d = getComputedStyle(e.container), h = parseFloat(d.marginLeft), g = parseFloat(d.marginTop);
          e.container.style.position = "fixed", e.keepInViewport ? (c >= e.minX && c + o < s.width && (e.lastPageX = n.pageX, e.container.style.left = c - h + "px"), f >= e.minY && f + a < s.height && (e.lastPageY = n.pageY, e.container.style.top = f - g + "px")) : (e.lastPageX = n.pageX, e.container.style.left = c - h + "px", e.lastPageY = n.pageY, e.container.style.top = f - g + "px");
        }
  ...
  components: {
    Portal: N,
    WindowMinimizeIcon: W,
    WindowMaximizeIcon: Z,
    TimesIcon: K
  }
};
function L(t) {
...
function S(t) {
  for (var e = 1; e < arguments.length; e++) {
    var n = arguments[e] != null ? arguments[e] : {};
    e % 2 ? M(Object(n), !0).forEach(function(o) {
      xe(t, o, n[o]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(n)) : M(Object(n)).forEach(function(o) {
      Object.defineProperty(t, o, Object.getOwnPropertyDescriptor(n, o));
    });
  }
  return t;
...
function xe(t, e, n) {
  return e = ze(e), e in t ? Object.defineProperty(t, e, { value: n, enumerable: !0, configurable: !0, writable: !0 }) : t[e] = n, t;
}
function ze(t) {
  var e = Fe(t, "string");
...
var Be = ["aria-labelledby", "aria-modal"], ke = ["id"], $e = ["autofocus", "tabindex"], Ie = ["autofocus", "aria-label"];
function Oe(t, e, n, o, a, i) {
  var p = q("Portal"), l = $("ripple"), c = $("focustrap");
  return u(), C(p, {
    appendTo: t.appendTo
  }, {
    default: I(function() {
      return [a.containerVisible ? (u(), b("div", m({
        key: 0,
        ref: i.maskRef,
        class: t.cx("mask"),
        style: t.sx("mask", !0, {
        ...
        default: I(function() {
          return [t.visible ? x((u(), b("div", m({
            ...
            return [t.header ? (u(), b("span", m({
              key: 0,
              id: i.ariaLabelledById,
              class: t.cx("title")
            }, t.ptm("title")), O(t.header), 17, ke)) : y("", !0)];
          }), w("div", m({
            class: t.cx("icons")
          }, t.ptm("icons")), [t.maximizable ? x((u(), b("button", m({
            key: 0,
            ...
            type: "button"
          }, S(S({}, t.closeButtonProps), t.ptm("closeButton")), {
            "data-pc-group-section": "headericon"
          }), [v(t.$slots, "closeicon", {
            class: z(t.cx("closeButtonIcon"))
          }, function() {
            return [(u(), C(P(t.closeIcon ? "span" : "TimesIcon"), m({
              class: [t.cx("closeButtonIcon"), t.closeIcon]
            }, t.ptm("closeButtonIcon")), null, 16, ["class"]))];
          })], 16, Ie)), [[l]]) : y("", !0)], 16)], 16)) : y("", !0), w("div", m({
            ref: i.contentRef,
            class: [t.cx("content"), t.contentClass],
            style: t.contentStyle
          }, S(S({}, t.contentProps), t.ptm("content"))), [v(t.$slots, "default")], 16), t.footer || t.$slots.footer ? (u(), b("div", m({
            key: 1,
            ref: i.footerContainerRef,
            class: t.cx("footer")
          }, t.ptm("footer")), [v(t.$slots, "footer", {}, function() {
            return [Q(O(t.footer), 1)];
          })], 16)) : y("", !0)], 64))], 16, Be)), [[c, {
            disabled: !t.modal
          }]]) : y("", !0)];
        }),
...
De.render = Oe;
function je({ storageKey: t, defaultWidth: e, presets: n, fullVw: o = 94 }) {
  function a() {
    try {
      const s = localStorage.getItem(t);
      if (s === "full") return "full";
      const d = parseFloat(s);
      return Number.isFinite(d) ? d : e;
    } catch {
      return e;
    }
  }
  ...
  const l = ne(a()), c = A(() => p(l.value));
  function f(s) {
    l.value = s, i(s);
  }
  return { cssWidth: c, setWidth: f, presets: n };
}
const Pe = { class: "width-row" }, _e = {
  ...
  setup(t) {
    return (e, n) => (u(), b("div", Pe, [
      (u(!0), b(R, null, ie(t.presets, (o) => (u(), C(_(H), {
        key: o,
        label: String(o),
        text: "",
        size: "small",
        title: `Set editor width to ${o}px (capped to the window's width)`,
        onClick: (a) => t.setWidth(o)
      ...
      T(_(H), {
        ...
        onClick: n[0] || (n[0] = (o) => t.setWidth("full"))
      })
    ]));
  }
}, Me = /* @__PURE__ */ oe(_e, [["__scopeId", "data-v-d114d08b"]]);
export {
  ce as F,
  Me as P,
  K as a,
